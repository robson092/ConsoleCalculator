...
public class Calculator {
        ...
        while(true) {
            if(result != 0 && (!sc.hasNextInt())) {
                ...
                result = switch (operationType) {
                    ...
                    case "6", "pow" -> calculate.power(firstNum, secondNum);
    ...
    private boolean validateOperationChosen() {
        List<String> oprerators = List.of("1", "+", "2", "-", "3", "*", "4", "/", "5", "%", "6", "pow", "7", "sqr");
    ...
    private void continueIfOperandEntered() {
            ...
            result = switch (operationType) {
                ...
                case "6", "pow" -> calculate.power(result, secondNum);
